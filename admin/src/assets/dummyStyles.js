...
export const doctorDetailStyles = {
  // Layout styles
pageContainer: "min-h-screen font-serif bg-gradient-to-br from-emerald-50 via-white to-green-50 dark:bg-gradient-to-br dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 p-4 sm:p-6",
 ...
 maxWidthContainerXL: "max-w-7xl",
  ...
  headerTitle: "text-3xl sm:text-4xl md:text-5xl font-bold bg-gradient-to-r from-emerald-600 to-cyan-600 bg-clip-text text-transparent mt-2 sm:mt-0",
  
  // Form styles
  formContainer: "bg-white dark:bg-gray-800/80 backdrop-blur-sm border border-emerald-100 dark:border-gray-700 shadow-2xl p-6 sm:p-8 rounded-3xl mb-16",
  formGrid: "grid grid-cols-1 md:grid-cols-2 gap-6",
  
  // Input styles
  inputBase: "p-3 rounded-full border-2 border-emerald-100 dark:border-gray-700 bg-white dark:bg-gray-800 placeholder:text-gray-400 shadow-sm w-full focus:outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100 transition-all",
  textareaBase: "p-3 rounded-xl border-2 border-emerald-100 dark:border-gray-700 bg-white dark:bg-gray-800 placeholder:text-gray-400 shadow-sm w-full focus:outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100 transition-all",
  inputWithIcon: "pr-12",
  
  // File upload styles
  fileInput: "w-40 md:w-[180px] border-2 border-emerald-100 dark:border-gray-700 rounded-full p-2 text-sm bg-white dark:bg-gray-800 focus:border-emerald-400 transition",
  ...
  scheduleContainer: "p-6 bg-emerald-50 rounded-2xl border border-emerald-100 dark:border-gray-700",
  ...
  scheduleDateInput: "p-3 rounded-full border-2 border-emerald-100 dark:border-gray-700 w-full sm:w-auto",
  scheduleTimeSelect: "p-3 rounded-full border-2 border-emerald-100 dark:border-gray-700 w-full sm:w-auto",
  ...
  slotItem: "flex justify-between items-center bg-emerald-50 p-3 rounded-xl border border-emerald-100 dark:border-gray-700 shadow-sm hover:shadow-md text-emerald-800",
...
export const pageStyles = {
  ...
  searchContainer: "flex items-center bg-white dark:bg-gray-800 rounded-full px-3 py-2 shadow-sm w-full sm:w-72",
  ...
  dateFilter: "bg-white dark:bg-gray-800 rounded-full px-3 py-2 shadow-sm flex items-center gap-2 w-full sm:w-auto",
  ...
  loadingErrorContainer: "col-span-full text-center text-emerald-600 py-12 rounded-lg bg-white dark:bg-gray-800/60 border border-emerald-100 dark:border-gray-700",
  errorContainer: "col-span-full text-center text-rose-600 py-6 rounded-lg bg-white dark:bg-gray-800/60 border border-rose-100",
  noResultsContainer: "col-span-full text-center text-emerald-600 py-12 rounded-lg bg-white dark:bg-gray-800/60 border border-emerald-100 dark:border-gray-700",
  
  gridContainer: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4",
  
  card: "bg-white dark:bg-gray-800 rounded-2xl p-3 sm:p-4 md:p-5 shadow-sm border border-emerald-100 dark:border-gray-700 flex flex-col gap-3 hover:shadow-md transform hover:-translate-y-1 transition",
  ...
  showMoreButton: "px-4 py-2 cursor-pointer rounded-full bg-white dark:bg-gray-800 border border-emerald-200 shadow-sm hover:shadow-md transition",
};
...
export const statusClasses = (status) => {
  ...
  if (s === "completed")
    return "bg-emerald-50 text-emerald-700 border border-emerald-100 dark:border-gray-700";
  if (s === "rescheduled")
...
pageContainer: "min-h-screen font-serif bg-gradient-to-br from-emerald-50 via-white to-green-50 dark:bg-gradient-to-br dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 p-4 sm:p-6",
  ...
  statCard: "p-4 rounded-full bg-gradient-to-br from-emerald-100 to-emerald-50 shadow-sm border border-green-100 dark:bg-gradient-to-br dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 ",
  statCardContent: "flex items-center gap-3",
  statIconContainer: "p-2 bg-white dark:bg-gray-800/80 rounded-full shadow-inner",
  ...
  searchInput: "pl-10 pr-4 py-2 rounded-full shadow-sm border border-green-200 bg-white dark:bg-gray-800 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-green-200 w-full",
  ...
  tableContainer: "bg-white dark:bg-gray-800 rounded-2xl shadow overflow-hidden",
  ...
  tableBody: "bg-white dark:bg-gray-800 divide-y divide-green-50",
  ...
  mobileDoctorCard: "bg-white dark:bg-gray-800 rounded-xl shadow p-3 border border-green-50",
  ...
  showMoreButton: "px-4 py-2 rounded-full bg-white dark:bg-gray-800 border border-green-200 shadow-sm hover:bg-green-50 transition",
...
export const addServiceStyles = {
  // Container styles
  container: {
    main: "min-h-screen font-serif bg-gradient-to-br from-emerald-50 via-emerald-100 to-teal-50 relative flex items-center justify-center p-4 sm:p-6 overflow-x-hidden dark:bg-gradient-to-br dark:from-gray-900 dark:via-gray-900 dark:to-gray-900",
    form: "w-full max-w-5xl bg-white dark:bg-gray-800/90 backdrop-blur-sm rounded-3xl p-6 sm:p-8 shadow-2xl border border-emerald-100 dark:border-gray-700/50 box-border"
  },
  ...
  // Button styles
  buttons: {
    reset: "w-full sm:w-auto px-4 py-2 cursor-pointer rounded-full bg-white dark:bg-gray-800 border border-emerald-100 dark:border-gray-700 hover:shadow transition-shadow duration-200",
    ...
    uploadImage: "flex-1 inline-flex items-center justify-center gap-2 px-4 py-2 rounded-full bg-white dark:bg-gray-800 border border-emerald-200 hover:shadow transition-shadow",
    removeImage: "px-3 py-2 rounded-full bg-white dark:bg-gray-800 border border-red-100 hover:shadow transition-shadow",
    ...
    slotRemove: "p-1 rounded-full xl:-mr-1 hover:bg-white dark:bg-gray-800 transition-colors",
    toastClose: "p-1 rounded-full hover:bg-white dark:bg-gray-800/50 transition-colors"
  },
  ...
  imageUpload: {
    container: (hasError) => 
      `w-full rounded-2xl p-4 ${
        hasError 
          ? "border-2 border-red-200 bg-gradient-to-bfrom-red-50 to-orange-50" 
          : "bg-gradient-to-b from-emerald-50 to-teal-50 border border-emerald-100 dark:border-gray-700"
      } shadow-inner flex flex-col items-center gap-4`,
    preview: "w-full h-56 rounded-xl overflow-hidden bg-white dark:bg-gray-800 flex items-center justify-center border border-emerald-100 dark:border-gray-700",
  ...
  formFields: {
    ...
    select: "mt-2 w-full px-4 py-3 rounded-full border border-emerald-100 dark:border-gray-700 text-gray-700 bg-white dark:bg-gray-800 appearance-none focus:ring-2 focus:ring-emerald-200 focus:outline-none",
    smallSelect: "mt-1 w-full px-3 py-2 rounded-full border border-emerald-100 dark:border-gray-700 text-gray-700 bg-white dark:bg-gray-800 appearance-none focus:ring-2 focus:ring-emerald-200 focus:outline-none",
    timeSelect: "mt-1 w-full px-2 py-2 rounded-full border border-emerald-100 dark:border-gray-700 text-gray-700 bg-white dark:bg-gray-800 appearance-none focus:ring-2 focus:ring-emerald-200 focus:outline-none",
    ampmSelect: "mt-1 w-full px-1 py-2 rounded-full border border-emerald-100 dark:border-gray-700 text-gray-700 bg-white dark:bg-gray-800 appearance-none focus:ring-2 focus:ring-emerald-200 focus:outline-none"
  },
  ...
  instructions: {
    ...
    item: "flex items-start gap-3 my-2 bg-white dark:bg-gray-800 rounded-full p-3 border border-emerald-50 shadow-sm hover:shadow transition-shadow min-w-0",
    input: "flex-1 min-w-0 px-3 py-2 rounded-full border border-emerald-100 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-emerald-200",
  ...
  slots: {
    container: (hasError) => 
      `bg-gradient-to-br from-white to-emerald-50 dark:bg-gradient-to-br dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 rounded-2xl p-4 ${
        hasError 
          ? "border-2 border-red-200" 
          : "border border-emerald-50"
      } shadow-sm`,
    slotItem: "flex items-center gap-2 bg-linear-to-r from-emerald-50 to-teal-50 border border-emerald-100 dark:border-gray-700 px-2 py-2 my-1 rounded-full shadow hover:shadow-md transition-shadow min-w-0",
  ...
  toast: {
    ...
    toastSuccess: "bg-linear-to-r from-emerald-50 to-teal-50 border-emerald-100 dark:border-gray-700",
    iconContainer: (type) => {
      const styles = {
...
export const doctorListStyles = {
  ...
  searchBox: "flex items-center w-full sm:w-96 bg-white dark:bg-gray-800 rounded-full px-3 py-2 shadow-sm",
  searchIcon: "text-emerald-400",
  ...
  filterButton: (isActive, color) => {
    ...
    if (color === 'emerald') {
      return isActive
        ...
        : `${base} bg-white dark:bg-gray-800 text-emerald-700 border-emerald-200`;
    } else if (color === 'red') {
      return isActive
        ? `${base} bg-red-600 text-white border-red-600`
        : `${base} bg-white dark:bg-gray-800 text-red-600 border-red-100`;
    }
    return base;
  },
  ...
  article: "bg-linear-to-r from-emerald-100/50 to-white rounded-2xl shadow-md border border-emerald-100 dark:border-gray-700 overflow-hidden transition-all duration-300",
  ...
  toggleButton: (isOpen) => 
    `p-2 rounded-full cursor-pointer bg-white dark:bg-gray-800 shadow-sm transform transition ${
  ...
  expandableContent: "px-4 md:px-5 bg-white dark:bg-gray-800 overflow-auto sm:overflow-visible",
  ...
  scheduleSlot: "text-xs px-3 py-1 rounded-full border border-emerald-100 dark:border-gray-700 shadow-sm break-words",
  ...
  showMoreButton: "px-5 py-2 cursor-pointer rounded-full bg-white dark:bg-gray-800 border border-emerald-300 shadow-sm hover:shadow-md transition",
...
logoImage: "w-12 h-12 rounded-full",
  ...
  centerNavScrollContainer: "center-inner relative whitespace-nowrap rounded-3xl bg-white dark:bg-gray-800/95 lg:px-2 px-4 py-2 flex items-center gap-2 shadow-lg border border-gray-100 overflow-x-auto",
  ...
  mobileMenuInner: "rounded-xl bg-white dark:bg-gray-800 shadow-md p-3 space-y-2 border",
...
export const heroStyles = {
  ...
  // Content container
  contentBox: "bg-white dark:bg-gray-800/90 backdrop-blur-sm border border-emerald-100 dark:border-gray-700 rounded-3xl shadow-xl p-8 md:p-12 text-center",
 ...
 logoContainer: "flex items-center gap-2 relative z-10",
  ...
  infoCards: {
    ...
    card: "p-4 rounded-lg bg-emerald-50 border border-emerald-100 dark:border-gray-700 text-left",
...
pageContainer: "min-h-screen font-serif bg-gradient-to-br from-emerald-50 via-white to-green-50 dark:bg-gradient-to-br dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 p-4 sm:p-6",
  ...
  searchInput: "pl-12 pr-4 py-2 rounded-full border border-emerald-100 dark:border-gray-700 shadow-sm focus:outline-none focus:ring-2 focus:ring-emerald-200 transition w-full md:w-72 bg-white dark:bg-gray-800",
  
  // Grid styles
  servicesGrid: "grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-2 gap-6",
  
  // Service card styles
  serviceCard: "bg-white dark:bg-gray-800 rounded-2xl overflow-hidden transform transition hover:-translate-y-1 hover:shadow-2xl border border-emerald-50",
  ...
  inputBase: "w-full border rounded-lg px-3 py-2 outline-none transition focus:ring-2 focus:ring-green-200 focus:border-green-300 border-green-100 bg-white dark:bg-gray-800",
  ...
  fileInput: "w-full border border-emerald-300 rounded-full px-4 py-2 text-sm bg-white dark:bg-gray-800 cursor-pointer file:bg-emerald-50 file:border-0 file:px-4 file:py-1 file:rounded-full file:text-emerald-700 hover:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-200 transition",
  textarea: "min-h-[68px]",
  ...
  addSlotButton: "inline-flex cursor-pointer items-center gap-2 text-sm px-2 py-1 rounded-full border border-emerald-100 dark:border-gray-700",
  slotsContainer: "space-y-2 mt-2",
  slotRow: "flex flex-col sm:flex-row sm:items-center gap-2 w-full",
  slotDateInput: "border rounded-lg px-2 py-1 outline-none focus:ring-2 focus:ring-emerald-200 border-emerald-100 dark:border-gray-700 w-full sm:w-auto",
  slotTimeContainer: "flex gap-2 items-center w-full sm:w-auto",
  slotSelect: "border rounded-lg px-2 py-1 outline-none focus:ring-2 focus:ring-emerald-200 border-emerald-100 dark:border-gray-700 w-20",
  ...
  toastSuccess: "bg-white dark:bg-gray-800 border-emerald-100 dark:border-gray-700",
  toastError: "bg-white dark:bg-gray-800 border-slate-100",
...
export const serviceAppointmentsStyles = {
  ...
  searchInput: "pl-10 pr-10 w-full rounded-full border border-emerald-200 bg-white dark:bg-gray-800/90 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-emerald-200 transition-all",
  ...
  loadingContainer: "col-span-full rounded-2xl p-8 bg-white dark:bg-gray-800/90 border border-emerald-50 shadow-sm flex items-center justify-center gap-3",
  errorContainer: "col-span-full rounded-2xl p-4 bg-rose-50 border border-rose-100 text-rose-700",
  
  noResultsContainer: "col-span-full rounded-2xl p-8 bg-white dark:bg-gray-800/90 border border-emerald-50 shadow-sm flex items-center justify-center flex-col gap-3",
  ...
  cardInner: "card-inner rounded-2xl overflow-hidden border-2 border-emerald-300/60 p-5 bg-white dark:bg-gray-800/90 shadow-lg h-full flex flex-col justify-between",
  ...
  cancelButton: (isLocked) => 
    `px-3 py-1 rounded-full text-sm border ${
      isLocked
        ...
        : "bg-white dark:bg-gray-800 text-rose-600 border-rose-200 hover:shadow-sm"
    }`,
  
  legendContainer: "mt-6 p-4 rounded-lg bg-white dark:bg-gray-800/80 shadow-inner border border-emerald-100 dark:border-gray-700 text-sm flex flex-col sm:flex-row flex-wrap items-center gap-4",
  ...
  statusSelect: (terminal) => 
    `text-sm cursor-pointer px-3 py-1 rounded-full border focus:outline-none transition ${
      terminal
        ...
        : "bg-white dark:bg-gray-800 text-emerald-800 border-emerald-400"
    }`,
  ...
  rescheduleButton: (terminal) => 
    `text-sm px-3 py-1 rounded-full cursor-pointer border transition ${
      terminal
        ? "bg-gray-50 text-gray-400 border-gray-200 cursor-not-allowed"
        : "bg-white dark:bg-gray-800 text-emerald-800 border-emerald-400 hover:shadow-sm"
    }`,
  ...
  toast: "max-w-xs w-full rounded-lg shadow-lg px-4 py-3 border-l-4 border-emerald-400 bg-white dark:bg-gray-800/95 backdrop-blur-sm",
  toastContent: "flex items-start gap-3",
...
export const serviceDashboardStyles = {
  // Container styles
  container: "min-h-screen font-serif p-4 sm:p-6 bg-gradient-to-bfrom-emerald-50 via-emerald-25 to-white",
    ...
    button: (hasServicesProp) => 
      `px-3 py-1 rounded-full text-sm ${
        hasServicesProp
          ...
          : "bg-white dark:bg-gray-800 text-emerald-600 border border-emerald-200 hover:shadow-sm"
      }`
  },
  ...
  search: {
    ...
    inputContainer: "flex items-center gap-2 bg-white dark:bg-gray-800 px-4 py-2 rounded-full shadow-sm border border-emerald-200 w-full sm:w-64",
    input: "w-full text-sm outline-none"
  },
  
  // Table styles
  table: {
    container: "bg-white dark:bg-gray-800 rounded-2xl shadow-sm overflow-hidden border-b border-transparent",
    ...
    row: "px-4 py-4 font-serif hover:shadow-md transition bg-white dark:bg-gray-800 md:bg-transparent",
  ...
  showMore: {
    ...
    button: "px-4 py-2 rounded-full cursor-pointer bg-white dark:bg-gray-800 border border-green-200 shadow-sm hover:bg-green-50 transition"
  },
  
  // StatCard component styles
  statCard: {
    container: "rounded-full bg-gradient-to-br from-emerald-100 to-emerald-50 dark:bg-gradient-to-br dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 shadow-sm border border-green-100 p-4 gap-4 flex items-center",
