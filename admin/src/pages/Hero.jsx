               ...
               <div className={heroStyles.decorativeBg.container}>
                  ...
                  <div className={heroStyles.contentBox}>
                     ...
                     <h1 className={heroStyles.heading}>
                        {isDoctor ? `Welcome, Dr. ${userName}` : "Welcome To CuraDesk Admin Panel"}

                     </h1>

                     <p className={heroStyles.description}>
                        {isDoctor ? "View patient histories, manage appointments, and analyze medical reports securely within your professional dashboard."
                           : "Coordinate hospital administration, manage healthcare professionals, and oversee patient records from a comprehensive control panel."}
                     </p>
                     {/* info cards */}
